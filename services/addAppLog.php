...
//
// File: addAppLog.php - Add an entry to the appLogs table
//
// Input JSON:
...
if (($_SERVER["REQUEST_METHOD"] === "POST") &&
    ...
    if ($postBody !== "") {
        ...
        }   // End if (array_key_exists("log", $userRequest))
        ...
        if ($bitmask === 1) {
            ...
            $errorCode    = 4;
            $errorMessage = "addAppLog: Not all parameters were found to process this input";
        }   //  End if ($bitmask === 1)
